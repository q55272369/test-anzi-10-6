    ...
    <React.StrictMode>
      <WidgetContainer>
        ...
        <div className="flex h-[58%] w-full flex-row items-start overflow-hidden px-3.5 pt-5  md:flex-row md:items-center md:justify-center md:space-x-3 md:px-3 md:py-2.5 lg:space-x-4 lg:px-5 lg:py-4">
           ...
           <span className="md:text-3xl md:font-medium  font-bold">联盟发展计划已推出</span>
           </div>
        ...
        >
          ...
          <button onClick={()=>{window.open('https://pro-plus.top')}} type="submit" className="flex w-full justify-center rounded-md bg-red-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-400" 
              >立即查看</button>
          </div>
        </div>
        </div>
